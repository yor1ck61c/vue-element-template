  ...
  <el-container>
    <el-header style="margin-top: 30px">
      <el-form :inline="true" :model="SearchInfo" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button type="primary" @click="onResidentSign">居民建档</el-button>
        </el-form-item>
      </el-form>
      <div id="residentSign" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="residentSign" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" style="pointer-events:auto">
          <div class="modal-content">
            <div class="modal-header">
              <h5 id="residentSignTitle" class="modal-title">居民建档</h5>
              ...
              <div class="container">
                ...
                <div class="row" style="font-size: 16px; text-align: center">
                  ...
                  <table width="10%" border="1">
                    <tbody>
                      <tr>
                        <td width="10%" height="278px">&nbsp;家族史</td>
                      </tr>
                    </tbody>
                  </table>
                  <table width="90%" border="1">
...
export default {
  ...
  created() {
    ...
    Axios.post('testURL').then((res) => {
      that.BasicRecordDataTable = res.data.BasicRecordDataTable
    })
  },
  methods: {
    onSearch: function() {},
    onResidentSign: function() {
      $('#residentSign').modal('show')
    },
    saveInfo: function() {}
  }
